                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar me-2"><img class="avatar-img img-fluid" src="{{ asset('/storage/app/matriz/'.$matriz->profile_photo_path)}}" /></div>
                                    {{$matriz->name}}
                                </div>
                            </td>
                            <td>{{$matriz->cnpj}}</td>
                            <td>{{$matriz->phone}}</td>
                            <td>{{$matriz->email}}</td>
                            <td><span class="badge bg-green-soft text-green">{{$matriz->natureza}}</span></td>
                            <td>
