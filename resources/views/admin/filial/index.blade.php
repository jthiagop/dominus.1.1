        ...
        <div class="card card-waves mb-4 mt-5">
            <div class="card-body p-5">
                <div class="row align-items-center justify-content-between">
                    <div class="col">
                        <h2 class="text-primary">Bem-vindo, seu painel está pronto!</h2>
                        <p class="text-gray-700">Ótimo trabalho, seu painel de afiliados está pronto para funcionar! Você pode visualizar vendas, gerar links, preparar cupons e baixar relatórios de afiliados usando este painel.</p>
