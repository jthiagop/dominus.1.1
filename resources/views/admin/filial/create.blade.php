            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('matriz.list') }}">
        ...
        <form action="{{ route('matriz.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Detalhes da Matriz</div>
                        <div class="card-body">
                            <!-- Form Row-->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input class="form-control" name="name" id="inputFirstName" title="Razão Social"
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="inputLastName" name="phone" type="text"
                                        placeholder="(00) 0.0000-0000" value="" />
                                </div>
                                <div class="col-md-8">
                                    <label class="small mb-1" for="inputLastName">E-Mail</label>
                                    <input class="form-control" id="inputLastName" name="email" type="text"
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputLastName" name="logradouro" type="text"
                                        placeholder="Digite o logradouro" value="" />
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="file" name="profile_photo_path" id="profile_photo_path"></input>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
